  ...
  List<Map<String, dynamic>> formatModelInspecciones(List<dynamic> data) {
    ...
    for (var item in data) {
      dataTemp.add({
        ...
        'descripcion_problema_eficiencia': item['inspeccionEficiencias']['descripcionProblema'],
        'calificacion_eficiencia': item['inspeccionEficiencias']['calificacion'],
        'comentarios_eficiencia': item['inspeccionEficiencias']['comentarios'],
        'imagen_eficiencia': item['inspeccionEficiencias']['imagen'],
        'imagen_cloudinary_eficiencia': item['inspeccionEficiencias']['imagenCloudinary'],
        'estado': item['estado'],

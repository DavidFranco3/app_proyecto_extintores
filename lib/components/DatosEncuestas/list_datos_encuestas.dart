...
class TblDatosEncuestas extends StatefulWidget {
  ...
  @override
  _TblDatosEncuestasState createState() => _TblDatosEncuestasState();
}

class _TblDatosEncuestasState extends State<TblDatosEncuestas> {

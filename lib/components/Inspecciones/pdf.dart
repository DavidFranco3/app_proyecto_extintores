          ...
          if (response3.statusCode == 200) {
            ...
            if (response4.statusCode == 200) {
              ...
              if (response5.statusCode == 200) {
                ...
                final imageFinalUrl1 = data['imagenes_finales'][0]['sharedLink']
                    ?.replaceAll("dl=0", "dl=1");
                print("Link de la imagen 1: $imageFinalUrl1");

                if (imageFinalUrl1 == null || imageFinalUrl1.isEmpty) {
                  print("URL de la imagen no válida");
                  return;
                }

                // Descargar la imagen
                final responseFinal1 =
                    await http.get(Uri.parse(imageFinalUrl1));
                if (responseFinal1.statusCode == 200) {
                  final Uint8List imageBytesFinal1 = responseFinal1.bodyBytes;
                  print("Imagen descargada correctamente");

                  final imageFinalUrl2 = data['imagenes_finales'][1]
                          ['sharedLink']
                      ?.replaceAll("dl=0", "dl=1");
                  print("Link de la imagen 1: $imageFinalUrl2");

                  if (imageFinalUrl2 == null || imageFinalUrl2.isEmpty) {
                    print("URL de la imagen no válida");
                    return;
                  }

                  // Descargar la imagen
                  final responseFinal2 =
                      await http.get(Uri.parse(imageFinalUrl2));
                  if (responseFinal2.statusCode == 200) {
                    final Uint8List imageBytesFinal2 = responseFinal2.bodyBytes;
                    print("Imagen descargada correctamente");

                    final imageFinalUrl3 = data['imagenes_finales'][2]
                            ['sharedLink']
                        ?.replaceAll("dl=0", "dl=1");
                    print("Link de la imagen 1: $imageFinalUrl3");

                    if (imageFinalUrl3 == null || imageFinalUrl3.isEmpty) {
                      print("URL de la imagen no válida");
                      return;
                    }

                    // Descargar la imagen
                    final responseFinal3 =
                        await http.get(Uri.parse(imageFinalUrl3));
                    if (responseFinal3.statusCode == 200) {
                      final Uint8List imageBytesFinal3 =
                          responseFinal3.bodyBytes;
                      print("Imagen descargada correctamente");
                      ...
                      if (response6.statusCode == 200) {
                        ...
                        // Verificar comentario
                        final comentario6 = data['imagenes'][5]['comentario'] ??
                            'Sin comentario';
                        ...
                        if (response7.statusCode == 200) {
                          ...
                          // Verificar comentario
                          final comentario7 = data['imagenes'][6]
                                  ['comentario'] ??
                              'Sin comentario';
                          ...
                          final imageUrlLogo = data['imagen_cliente']
                              ?.replaceAll("dl=0", "dl=1");
                          ...
                          if (responseLogo.statusCode == 200) {
                            final Uint8List imageBytesLogo =
                                responseLogo.bodyBytes;
                            print("Imagen descargada correctamente");

                            final imageUrlFirma = data["firma_usuario"]
                                ?.replaceAll("dl=0", "dl=1");
                            print(
                                "Link de la imagen de la firma: $imageUrlFirma");

                            if (imageUrlFirma == null ||
                                imageUrlFirma.isEmpty) {
                              print("URL de la imagen no válida");
                              return;
                            }
                              ...
                              pdf.addPage(
                                pw.Page(
                                  build: (pw.Context context) {
                                    ...
                                    return pw.Center(
                                      child: pw.Image(
                                        pw.MemoryImage(imageBytesFinal1),
                                        width: pageWidth * 0.9,
                              ...
                              pdf.addPage(
                                pw.Page(
                                  build: (pw.Context context) {
                                    ...
                                    return pw.Center(
                                      child: pw.Image(
                                        pw.MemoryImage(imageBytesFinal2),
                                        width: pageWidth * 0.9,
                                        height: pageHeight * 0.9,
                                        fit: pw.BoxFit.contain,
                                      ),
                              ...
                              pdf.addPage(
                                pw.Page(
                                  build: (pw.Context context) {
                                    ...
                                    return pw.Center(
                                      child: pw.Image(
                                        pw.MemoryImage(imageBytesFinal3),
                                        width: pageWidth * 0.9,
                                        height: pageHeight * 0.9,
                                        fit: pw.BoxFit.contain,
                                      ),
